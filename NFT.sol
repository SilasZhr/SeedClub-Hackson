...
/**
 * @title NFTLtd
 * NFTLtd - Collect limited edition NFTs from _name Ltd
 */
contract NFTLtd is ERC1155Tradable {
    string public contractURI;

	constructor(address _proxyRegistryAddress, string memory _baseMetadataUri, string memory _contractURI, string memory _name, string memory _symbol) public ERC1155Tradable(_name, _symbol, _proxyRegistryAddress) {
